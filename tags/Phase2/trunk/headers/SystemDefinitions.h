...
#ifndef __SYSTEMDEFINITIONS__
#define __SYSTEMDEFINITIONS__
...
#ifdef QE_PREPROCESSOR_EXPORTLIB_SYSTEM // Specified as a preprocessor definition when compiling as a dynamic link library
    #define QE_LAYER_SYSTEM_SYMBOLS QE_EXPORT_SYMBOLS
    #define QE_LAYER_SYSTEM_EXTERN QE_EXPORT_SYMBOLS_EXTERN
#elif defined(QE_PREPROCESSOR_IMPORTLIB_SYSTEM) || defined(QE_PREPROCESSOR_IMPORTLIB_QUIMERAENGINE) // Specified as a preprocessor definition when compiling the client system
    #define QE_LAYER_SYSTEM_SYMBOLS QE_IMPORT_SYMBOLS
    #define QE_LAYER_SYSTEM_EXTERN QE_IMPORT_SYMBOLS_EXTERN
#else // Static library
    #define QE_LAYER_SYSTEM_SYMBOLS
    #define QE_LAYER_SYSTEM_EXTERN
#endif


#endif // __SYSTEMDEFINITIONS__
