...
public:
    ...
    EQIterationDirection(const EQIterationDirection::EnumType eValue) : m_value(eValue)
    {
    }
    ...
    EQIterationDirection(const enum_int_q nValue) : m_value(scast_q(nValue, const EQIterationDirection::EnumType))
    {
    }
    ...
    EQIterationDirection(const char* szValueName)
    {
        *this = szValueName;
    }
    ...
    EQIterationDirection(const EQIterationDirection &eValue) : m_value(eValue.m_value)
    {
    }
    ...
    /// </returns>
    EQIterationDirection& operator=(const enum_int_q nValue)
    {
    ...
    /// The enumerated type itself.
    /// </returns>
    EQIterationDirection& operator=(const char* szValueName)
    {
        bool bMatchFound = false;
        unsigned int uEnumStringIndex = 0;

        while(!bMatchFound && uEnumStringIndex < EQIterationDirection::_GetNumberOfValues())
        {
            bMatchFound = strcmp(sm_arStrings[uEnumStringIndex], szValueName) == 0;
            ++uEnumStringIndex;
        }

        QE_ASSERT_ERROR(uEnumStringIndex < EQIterationDirection::_GetNumberOfValues(), "The input string does not correspond to any valid enumeration value.");
    ...
    /// The enumerated type itself.
    /// </returns>
    EQIterationDirection& operator=(const EQIterationDirection::EnumType eValue)
    {
        m_value = eValue;
        return *this;
    }
    ...
    /// The enumerated type itself.
    /// </returns>
    EQIterationDirection& operator=(const EQIterationDirection &eValue)
    {
    ...
    static const Kinesis::QuimeraEngine::Common::DataTypes::QArrayBasic<const EnumType> GetValues()
    {
        ...
        static const QArrayBasic<const EnumType> ARRAY_OF_VALUES(sm_arValues, EQIterationDirection::_GetNumberOfValues());
    ...
    /// </returns>
    operator EQIterationDirection::EnumType() const
    {
        return m_value;
    }
...
private:
    ...
    /// </returns>
    inline static const char* _ConvertToString(const EQIterationDirection::EnumType eValue)
    {
        QE_ASSERT_ERROR(scast_q(eValue, unsigned int) < EQIterationDirection::_GetNumberOfValues(), "The enumeration value is not valid.");
...
private:
    ...
    /// </summary>
    static const EQIterationDirection::EnumType sm_arValues[];
