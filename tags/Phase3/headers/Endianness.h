...
#define QE_ENDIANNESS_LITTLEENDIAN 0x0

// Big-endian machine
#define QE_ENDIANNESS_BIGENDIAN 0x1
...
// --------------------------------------------------------------------------------------------------------
    ...
    #define QE_ENDIANNESS QE_ENDIANNESS_LITTLEENDIAN
    ...
    #define QE_ENDIANNESS QE_ENDIANNESS_BIGENDIAN
...
/// </returns>
inline bool QE_IS_LITTLE_ENDIAN()
{
