...
protected:
    ...
    /// </summary>
    static const TBitField FLAG_QUERY_IS_DEFINED;
    ...
    /// </summary>
    static const string_q SINGLE_DOT_SEGMENT;
    
    /// <summary>
    /// A dot segment compound of two dots ("..").
    /// </summary>
    static const string_q DOUBLE_DOT_SEGMENT;
    
    /// <summary>
    /// Two slash characters ("//").
    /// </summary>
    static const string_q DOUBLE_SLASH;
    
    /// <summary>
    /// A colon character (":").
    /// </summary>
    static const string_q CHAR_COLON;
    
    /// <summary>
    /// A slash character ("/").
    /// </summary>
    static const string_q CHAR_SLASH;
    
    /// <summary>
    /// A question mark character ("?").
    /// </summary>
    static const string_q CHAR_QUESTION_MARK;
    
    /// <summary>
    /// A number sign character ("#").
    /// </summary>
    static const string_q CHAR_NUMBER_SIGN;
    
    /// <summary>
    /// An opening square bracket character ("[").
    /// </summary>
    static const string_q CHAR_OPENING_SQUARE_BRACKET;
    
    /// <summary>
    /// A closing square bracket character ("]").
    /// </summary>
    static const string_q CHAR_CLOSING_SQUARE_BRACKET;
    
    /// <summary>
    /// An at sign character ("@").
    /// </summary>
    static const string_q CHAR_AT_SIGN;
    
    /// <summary>
    /// An exclamation mark character ("!").
    /// </summary>
    static const string_q CHAR_EXCLAMATION_MARK;
    
    /// <summary>
    /// A dollar sign character ("$").
    /// </summary>
    static const string_q CHAR_DOLLAR_SIGN;
    
    /// <summary>
    /// An ampersand character ("&").
    /// </summary>
    static const string_q CHAR_AMPERSAND;
    
    /// <summary>
    /// An apostrophe character ("'").
    /// </summary>
    static const string_q CHAR_APOSTROPHE;
    
    /// <summary>
    /// A comma character (",").
    /// </summary>
    static const string_q CHAR_COMMA;
    
    /// <summary>
    /// An opening parentheses character ("(").
    /// </summary>
    static const string_q CHAR_OPENING_PARENTHESES;
    
    /// <summary>
    /// A closing parentheses character (")").
    /// </summary>
    static const string_q CHAR_CLOSING_PARENTHESES;
    
    /// <summary>
    /// A semicolon character (";").
    /// </summary>
    static const string_q CHAR_SEMICOLON;
    
    /// <summary>
    /// An asterisk character ("*").
    /// </summary>
    static const string_q CHAR_ASTERISK;
    
    /// <summary>
    /// An equal sign character ("=").
    /// </summary>
    static const string_q CHAR_EQUAL_SIGN;
    
    /// <summary>
    /// A plus sign character ("+").
    /// </summary>
    static const string_q CHAR_PLUS_SIGN;
    
    /// <summary>
    /// A percent sign character ("%").
    /// </summary>
    static const string_q CHAR_PERCENT_SIGN;
...
public:
    ...
    /// </returns>
    QUri& operator=(const string_q &strUri);
    ...
    static void EncodePathSegment(const string_q &strInput, string_q &strOutput);
    ...
    /// <param name="strInput">[IN] The string to encode.</param>
    /// <param name="strOutput">[OUT] The result of the encoding process. The same string used as input can be used to store the result.</param>
    static void EncodeQueryOrFragment(const string_q &strInput, string_q &strOutput);
    ...
    static void Decode(const string_q &strInput, string_q &strOutput);
...
protected:
    ...
    /// It may be equal to string_q::PATTERN_NOT_FOUND.</param>
    ...
    virtual void DecomposeAuthority(const string_q &strInputUri, 
    ...
    /// <param name="nFragmentStartPosition">[IN] The position (zero-base index) of the first occurrence of the fragment separator ("#").
    /// It may be equal to string_q::PATTERN_NOT_FOUND.</param>
    virtual void DecomposePath(const string_q &strInputUri, 
                               const int nPathStartPosition, 
                               const int nQueryStartPosition, 
                               const int nFragmentStartPosition);
...
private:
    ...
    /// <param name="strInput">[IN] The string to encode.</param>
    /// <param name="strOutput">[OUT] The result of the encoding process. The same string used as input can be used to store the result.</param>
    static void Encode(const bool bIsPathSegment, const string_q &strInput, string_q &strOutput);
    ...
    void DecomposeUri(const string_q &strInputUri);
...
public:
    ...
    /// </returns>
    string_q GetOriginalString() const;
