...
#ifndef __QNTREEITERATORMOCK__
#define __QNTREEITERATORMOCK__
...
public:
    ...
    // Constructor bypass
    QNTreeIteratorMock(const QNTree<T>* pTree, const pointer_uint_q uPosition, const EQTreeTraversalOrder &eTraversalOrder) : QNTree<T>::QNTreeIterator(pTree, uPosition, eTraversalOrder)
    {
    }
