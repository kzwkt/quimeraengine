...
#ifdef QE_PREPROCESSOR_EXPORTLIB_COMMON // Specified as a preprocessor definition when compiling as a dynamic link library
    #define QE_LAYER_COMMON_SYMBOLS QE_EXPORT_SYMBOLS
    #define QE_LAYER_COMMON_EXTERN QE_EXPORT_SYMBOLS_EXTERN
#elif defined(QE_PREPROCESSOR_IMPORTLIB_COMMON) || defined(QE_PREPROCESSOR_IMPORTLIB_QUIMERAENGINE) // Specified as a preprocessor definition when compiling the client system
    #define QE_LAYER_COMMON_SYMBOLS QE_IMPORT_SYMBOLS
    #define QE_LAYER_COMMON_EXTERN QE_IMPORT_SYMBOLS_EXTERN
#else // Static library
    #define QE_LAYER_COMMON_SYMBOLS
    #define QE_LAYER_COMMON_EXTERN
#endif


#endif // __COMMONDEFINITIONS__
