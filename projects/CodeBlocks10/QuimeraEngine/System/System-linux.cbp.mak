...
CFLAGS_DEBUGLINUX32SHAREDRTDYNAMIC =  -Wshadow -Wredundant-decls -Wcast-align -Winline -Wmissing-include-dirs -Wswitch-default -std=c++98 -Wall -g -m32 -D_DEBUG -DQE_PREPROCESSOR_COMPILER_SHAREDLIB
...
OUT_DEBUGLINUX32SHAREDRTDYNAMIC = $(MAKEPATH)trunk/bin/CodeBlocks10/DebugLinux32SharedrtDynamic/QuimeraEngineSystem.so
