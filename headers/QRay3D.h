...
public:
    ...
    ///     E_Contained: The ray lies on plane.
    ///     E_PositiveSide: The ray is fully contained in the positive side of the space defined by the plane.
    ///     E_NegativeSide: The ray is fully contained in the negative side of the space defined by the plane.
    ///     E_BothSides: The ray cross the plane.
