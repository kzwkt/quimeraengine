...
private:
    ...
    QVector4 TransformImp(const QTranslationMatrix<MatrixT> &translation) const;
    ...
    /// </returns>
    template <class MatrixT>
    QVector4 TransformImp(const QTransformationMatrix<MatrixT> &transformation) const;
};
