...
public:
    ...
    enum EnumType
    {
        E_DepthFirstInOrder    = QE_ENUMERATION_MIN_VALUE, /*!< Depth-first in-order. Left child is visited first, then the current node and finaly the right child. */
...
public:
    ...
    EQTreeTraversalOrder(const EQTreeTraversalOrder::EnumType eValue) : m_value(eValue)
    {
    }
    ...
    EQTreeTraversalOrder(const enum_int_q nValue) : m_value(scast_q(nValue, const EQTreeTraversalOrder::EnumType))
    {
    }
    ...
    EQTreeTraversalOrder(const char* szValueName)
    {
        *this = szValueName;
    }
    ...
    EQTreeTraversalOrder(const EQTreeTraversalOrder &eValue) : m_value(eValue.m_value)
    {
    }
    ...
    /// </returns>
    EQTreeTraversalOrder& operator=(const enum_int_q nValue)
    {
    ...
    /// The enumerated type itself.
    /// </returns>
    EQTreeTraversalOrder& operator=(const char* szValueName)
    {
        bool bMatchFound = false;
        unsigned int uEnumStringIndex = 0;

        while(!bMatchFound && uEnumStringIndex < EQTreeTraversalOrder::_GetNumberOfValues())
        {
            bMatchFound = strcmp(sm_arStrings[uEnumStringIndex], szValueName) == 0;
            ++uEnumStringIndex;
        }

        QE_ASSERT_ERROR(uEnumStringIndex < EQTreeTraversalOrder::_GetNumberOfValues(), "The input string does not correspond to any valid enumeration value.");
    ...
    /// The enumerated type itself.
    /// </returns>
    EQTreeTraversalOrder& operator=(const EQTreeTraversalOrder::EnumType eValue)
    {
        m_value = eValue;
        return *this;
    }
    ...
    /// The enumerated type itself.
    /// </returns>
    EQTreeTraversalOrder& operator=(const EQTreeTraversalOrder &eValue)
    {
    ...
    static const Kinesis::QuimeraEngine::Common::DataTypes::QArrayBasic<const EnumType> GetValues()
    {
        ...
        static const QArrayBasic<const EnumType> ARRAY_OF_VALUES(sm_arValues, EQTreeTraversalOrder::_GetNumberOfValues());
    ...
    /// </returns>
    operator EQTreeTraversalOrder::EnumType() const
    {
        return m_value;
    }
...
private:
    ...
    /// </returns>
    inline static const char* _ConvertToString(const EQTreeTraversalOrder::EnumType eValue)
    {
        QE_ASSERT_ERROR(scast_q(eValue, unsigned int) < EQTreeTraversalOrder::_GetNumberOfValues(), "The enumeration value is not valid.");
...
private:
    ...
    /// </summary>
    static const EQTreeTraversalOrder::EnumType sm_arValues[];
