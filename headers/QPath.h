...
/// </remarks>
class QE_LAYER_SYSTEM_SYMBOLS QPath
{
    // CONSTANTS
    // ---------------
private:
    ...
    /// A dot character (".").
    /// </summary>
    static const Kinesis::QuimeraEngine::Common::DataTypes::char_q DOT;
...
public:
    ...
    /// </returns>
    bool operator==(const QPath &path) const;
    ...
    void AppendDirectory(const string_q &strDirectory);
    ...
    void Resolve(const QPath &relativePath);
    ...
    /// </returns>
    string_q GetAbsolutePath() const;
    ...
    /// </returns>
    string_q GetRelativePath() const;
...
protected:
    ...
    static void _RemoveNotAllowedCharactersInPath(string_q &strPathToBeReplaced);
    ...
    static void _RemoveNotAllowedCharactersInHostname(string_q &strHostnameToBeReplaced);
    ...
    /// </returns>
    static bool _ValidateHostname(const string_q &strHostname);
    ...
    static void _ResolveDotSegments(string_q &strPathToResolve);
    ...
    static void _ExtractHostnameFromPath(string_q &strPath, string_q &strHostname);
    ...
    /// </returns>
    static bool _IsIP(const string_q &strHostname);
...
public:
    ...
    /// </returns>
    string_q GetFilenameWithoutExtension() const;
