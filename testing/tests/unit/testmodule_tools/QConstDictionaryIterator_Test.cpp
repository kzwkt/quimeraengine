...
/// <summary>
/// Checks that an assertion fails when input dictionary is null.
/// </summary>
QTEST_CASE ( Constructor_AssertionFailsWhenInputDictionaryIsNull_Test )
{
    // [Preparation]
    QDictionary<string_q, int>* DICTIONARY = null_q;
