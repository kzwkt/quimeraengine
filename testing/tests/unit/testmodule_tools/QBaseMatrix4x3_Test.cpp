...
QTEST_SUITE_BEGIN( QBaseMatrix4x3_TestSuite )
...
QTEST_CASE ( Constructor2_EveryMatrixElementCopiedProperly_Test )
{
    ...
    const QBaseMatrix4x3 MATRIX_TO_COPY(EXPECTED_VALUE_FOR_00, EXPECTED_VALUE_FOR_01, EXPECTED_VALUE_FOR_02,
    ...
    // Execution
    QBaseMatrix4x3 matrixUT = MATRIX_TO_COPY;
...
QTEST_CASE ( Constructor3_ValueIsSetForAllComponents_Test )
{
    ...
    QBaseMatrix4x3 matrixUT(EXPECTED_VALUE_FOR_ALL);
...
QTEST_CASE ( Constructor4_ValuesAreSetProperly_Test )
{
   // Preparation
	...
	// Execution
    QBaseMatrix4x3 matrixUT(EXPECTED_VALUE_FOR_00, EXPECTED_VALUE_FOR_01, EXPECTED_VALUE_FOR_02,
                            EXPECTED_VALUE_FOR_10, EXPECTED_VALUE_FOR_11, EXPECTED_VALUE_FOR_12,
                            EXPECTED_VALUE_FOR_20, EXPECTED_VALUE_FOR_21, EXPECTED_VALUE_FOR_22,
                            EXPECTED_VALUE_FOR_30, EXPECTED_VALUE_FOR_31, EXPECTED_VALUE_FOR_32);
...
QTEST_CASE ( Constructor5_MatrixComponentsAreFilledWithValidReferenceTo12Floats_Test )
{
   // Preparation
	...
	// Execution
    QBaseMatrix4x3 matrixUT(VALID_ARRAY_OF_12_FLOATS);
...
QTEST_CASE ( Constructor5_AssertionFailsWhenPointerIsNull_Test )
{
    ...
    try
    {
        QBaseMatrix4x3 vMatrixUT(NULL_ARRAY);
    }
...
QTEST_CASE ( Constructor6_MatrixComponentsAreSetToValidVF32PackedValues_Test )
{
	...
	// Execution
	QBaseMatrix4x3 matrixUT(PACK0, PACK1, PACK2, PACK3);
...
{
    // Preparation
    const QBaseMatrix4x3 LEFT_OPERAND(SQFloat::Epsilon);
    const QBaseMatrix4x3 RIGHT_OPERAND(SQFloat::_0);
...
QTEST_CASE ( OperatorEquality_TrueWhenOperandsDifferLessThanTolerance_Test )
{
    ...
    const QBaseMatrix4x3 LEFT_OPERAND(HALF_TOLERANCE);
    const QBaseMatrix4x3 RIGHT_OPERAND(SQFloat::_0);
...
QTEST_CASE ( OperatorEquality_FalseWhenOperandsDifferGreaterThanTolerance_Test )
{
    ...
    const QBaseMatrix4x3 LEFT_OPERAND(ONE_AND_A_HALF_TOLERANCE);
    const QBaseMatrix4x3 RIGHT_OPERAND(SQFloat::_0);
...
{
    // Preparation
    const QBaseMatrix4x3 LEFT_OPERAND(SQFloat::_1, SQFloat::_2, SQFloat::_3,
    ...
    const QBaseMatrix4x3 RIGHT_OPERAND(SQFloat::_1, SQFloat::_2, SQFloat::_3,
                                       SQFloat::_4, SQFloat::_5, SQFloat::_6,
                                       SQFloat::_7, SQFloat::_8, SQFloat::_9,
                                       SQFloat::_10, SQFloat::_10 + SQFloat::_1, SQFloat::_10 + SQFloat::_2);
