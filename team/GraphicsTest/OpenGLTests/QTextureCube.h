...
public:
    ...
    QTextureCube(const GLuint textureId, const GLenum type, const GLenum format, const EQTextureFormat::EnumType eFormat, const u32_q uWidth, const u8_q uMipmapLevels) :
                                ...
                                void** ppOutputSubtexture) const
    {
        ...
        QE_ASSERT_ERROR(nYOffset + uHeight > m_uWidth, "The region to be read lays outside the texture's dimensions.");
    ...
    virtual void GetFullContent(const u8_q uMipmapLevel, const u32_q uSubtextureSize, void** ppOutputSubtexture) const
    {
        ...
        if (ppOutputSubtexture == null_q)
        {
            ...
            // Allocate memory
            uFinalSubtextureSize = pixelFormatDescriptor.GetSize() * m_uWidth * m_uWidth * 6U;
            *ppOutputSubtexture = new u8_q[uFinalSubtextureSize];
        }
    ...
    {
        static const GLsizei DEPTH = 1;
        glTextureSubImage3D(m_textureId, uMipmapLevel, 0, 0, 0, m_uWidth, m_uWidth, DEPTH, m_format, m_type, pSubtexture);
    ...
    virtual void SetSubtexture(const i32_q nXOffset, const i32_q nYOffset, const QAbstractTextureCube::EQCubeMapFace eFace, const u32_q uWidth, const u32_q uHeight, const u8_q uMipmapLevel, const void* pSubtexture)
    {
        ...
        QE_ASSERT_ERROR(nYOffset + uHeight > m_uWidth, "The region to be written overwrites memory outside the texture's dimensions.");
