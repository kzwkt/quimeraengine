...
QTEST_CASE ( FriendOperatorProduct_EveryElementIsMultipliedByTheScalar_Test )
{
    ...
    const float_q EXPECTED_VALUE_FOR_30 = (float_q)26.0f;
    const float_q EXPECTED_VALUE_FOR_31 = (float_q)28.0f;
    const float_q EXPECTED_VALUE_FOR_32 = (float_q)30.0f;
    const float_q EXPECTED_VALUE_FOR_33 = (float_q)32.0f;
...
QTEST_CASE ( OperatorProduct2_ProductIsNotCommutative_Test )
{
    ...
    const QMatrix4x4 OPERAND2((float_q)17.0f, (float_q)18.0f, (float_q)19.0f, (float_q)20.0f,
                              (float_q)21.0f, (float_q)22.0f, (float_q)23.0f, (float_q)24.0f,
                              (float_q)25.0f, (float_q)26.0f, (float_q)27.0f, (float_q)28.0f,
                              (float_q)29.0f, (float_q)30.0f, (float_q)31.0f, (float_q)32.0f);
...
QTEST_CASE ( OperatorProduct3_CommonMatricesAreCorrectlyMultiplied_Test )
{
    ...
    const QBaseMatrix4x3 OPERAND2((float_q)17.0f, (float_q)18.0f, (float_q)19.0f,
                                  (float_q)21.0f, (float_q)22.0f, (float_q)23.0f,
                                  (float_q)25.0f, (float_q)26.0f, (float_q)27.0f,
                                  (float_q)29.0f, (float_q)30.0f, (float_q)31.0f);
...
QTEST_CASE ( OperatorDivision_EveryElementIsDividedByTheScalar_Test )
{
    ...
    const float_q EXPECTED_VALUE_FOR_30 = (float_q)13.0f;
    const float_q EXPECTED_VALUE_FOR_31 = (float_q)14.0f;
    const float_q EXPECTED_VALUE_FOR_32 = (float_q)15.0f;
    const float_q EXPECTED_VALUE_FOR_33 = (float_q)16.0f;
...
QTEST_CASE ( OperatorAddition_CommonMatricesAreCorrectlyAdded_Test )
{
    ...
    const float_q EXPECTED_VALUE_FOR_30 = (float_q)42.0f;
    const float_q EXPECTED_VALUE_FOR_31 = (float_q)44.0f;
    const float_q EXPECTED_VALUE_FOR_32 = (float_q)46.0f;
    const float_q EXPECTED_VALUE_FOR_33 = (float_q)48.0f;
...
QTEST_CASE ( OperatorSubtraction_CommonMatricesAreCorrectlySubtracted_Test )
{
    ...
    const QMatrix4x4 OPERAND1((float_q)18.0f, (float_q)20.0f, (float_q)22.0f, (float_q)24.0f,
                              (float_q)26.0f, (float_q)28.0f, (float_q)30.0f, (float_q)32.0f,
                              (float_q)34.0f, (float_q)36.0f, (float_q)38.0f, (float_q)40.0f,
                              (float_q)42.0f, (float_q)44.0f, (float_q)46.0f, (float_q)48.0f);
...
{
    // Preparation
    const QMatrix4x4 MATRIX((float_q)0.9f,  SQFloat::_1,    SQFloat::_2,     (float_q)0.3f,
                            SQFloat::_7,    SQFloat::_0_5,  SQFloat::_4,     (float_q)0.02f,
                            SQFloat::_3,    (float_q)0.07f, (float_q)0.033f, (float_q)0.001f,
                            SQFloat::_0_25, (float_q)0.08f, (float_q)6.6f,   SQFloat::_5);

    QMatrix4x4 EXPECTED_VALUE((float_q)0.9f,  SQFloat::_1,    SQFloat::_2,     (float_q)0.3f,
                              SQFloat::_7,    SQFloat::_0_5,  SQFloat::_4,     (float_q)0.02f,
                              SQFloat::_3,    (float_q)0.07f, (float_q)0.033f, (float_q)0.001f,
                              SQFloat::_0_25, (float_q)0.08f, (float_q)6.6f,   SQFloat::_5);
...
QTEST_CASE ( Transpose_TheRowAndColumOfElementsAreSwapped_Test )
{
    ...
    const QMatrix4x4 EXPECTED_VALUE(SQFloat::_1, SQFloat::_5, SQFloat::_9,    (float_q)13.0f,
                                    SQFloat::_2, SQFloat::_6, SQFloat::_10,   (float_q)14.0f,
                                    SQFloat::_3, SQFloat::_7, (float_q)11.0f, (float_q)15.0f,
                                    SQFloat::_4, SQFloat::_8, (float_q)12.0f, (float_q)16.0f);
...
QTEST_CASE ( GetDeterminant_ItsCorrectlyCalculatedForCommonMatrix_Test )
{
    ...
    const float_q EXPECTED_VALUE = (float_q)24.0f;
...
QTEST_CASE ( Invert_CommonMatrixIsCorrectlyInverted_Test )
{
    ...
    const QMatrix4x4 EXPECTED_VALUE(-SQFloat::_0_25,      SQFloat::_0_25,  -SQFloat::_0_5, SQFloat::_0_25,
                                    (float_q)0.66666669f, -SQFloat::_0_5,  SQFloat::_0_5,  (float_q)-0.16666667f,
                                    (float_q)0.16666667f, -SQFloat::_0_5,  SQFloat::_1,    (float_q)-0.16666667f,
...
{
    // Preparation
    const QMatrix4x4 MATRIX(SQFloat::_0,    SQFloat::_1,    SQFloat::_2,    (float_q)0.654321f,
                            SQFloat::_4,    SQFloat::_5,    SQFloat::_6,    (float_q)-2.2f,
                            SQFloat::_8,    SQFloat::_9,    SQFloat::_10,   (float_q)123456.0f,
                            (float_q)12.0f, (float_q)13.0f, (float_q)14.0f, (float_q)1234567.89f);
