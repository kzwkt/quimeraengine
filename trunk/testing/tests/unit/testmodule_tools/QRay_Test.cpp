...
// !!!
// IMPORTANT NOTE: Whatever the test you modify in this file, replicate the same changes in the QRay_QVector4_Test.cpp file!
...
QTEST_CASE_TEMPLATE ( Constructor2_ValuesAreCopiedProperly_Test, TQTemplateTypes )
{
    ...
    QRay<T, T> EXPECTED_RAY(EXPECTED_VALUE_FOR_ORIGIN, EXPECTED_VALUE_FOR_DIRECTION);

	// [Execution]
    QRay<T, T> rayUT(EXPECTED_RAY);
...
QTEST_CASE_TEMPLATE ( Constructor4_ValuesAreSetProperly_Test, TQTemplateTypes )
{
	...
	// [Execution]
    QRay<T, T> rayUT(EXPECTED_VALUE_FOR_ORIGIN, EXPECTED_VALUE_FOR_DIRECTION);
...
QTEST_CASE_TEMPLATE ( Constructor4_ConstructedRayIsNotNormalizedWhenDirectionVectorIsNot_Test, TQTemplateTypes )
{
	...
	// [Execution]
    QRay<T, T> rayUT(INPUT_VALUE_FOR_ORIGIN, INPUT_VALUE_FOR_DIRECTION);
...
{
    // [Preparation]
    QRay<T, T> EXPECTED_VALUE(T::GetNullVector(), T::GetNullVector());

	// [Execution]
    QRay<T, T> obtinedRay = QRay<T, T>::GetNullRay();
...
QTEST_CASE_TEMPLATE ( OperatorAssignation_RayIsAssignedProperlyToAnother_Test, TQTemplateTypes )
{
    ...
    // [Preparation]
    float_q VECTOR_COMPONENTS_ORIGIN[] = { SQFloat::_1, SQFloat::_2, SQFloat::_3 };
    float_q VECTOR_COMPONENTS_DIRECTION[] = { SQFloat::_1, SQFloat::_2, SQFloat::_3 };
    const T EXPECTED_VALUE_FOR_ORIGIN(VECTOR_COMPONENTS_ORIGIN);
    const T EXPECTED_VALUE_FOR_DIRECTION(VECTOR_COMPONENTS_DIRECTION);

    const QRay<T, T> OTHER_RAY = QRay<T, T>(EXPECTED_VALUE_FOR_ORIGIN, EXPECTED_VALUE_FOR_DIRECTION);
...
QTEST_CASE_TEMPLATE ( Invert_CorrectValueIsReturnedForACommonRay_Test, TQTemplateTypes )
{
    ...
    const QRay<T, T> EXPECTED_RAY = QRay<T, T>(RAY.Origin, -RAY.Direction);

	// [Execution]
    QRay<T, T> invertedRay = RAY.Invert();
...
QTEST_CASE_TEMPLATE ( Normalize_CorrectValueIsReturnedForACommonRay_Test, TQTemplateTypes )
{
    ...
    const QRay<T, T> RAY = QRay<T, T>(VALUE_FOR_ORIGIN, VALUE_FOR_DIRECTION);
    const QRay<T, T> EXPECTED_RAY = QRay<T, T>(RAY.Origin, RAY.Direction.Normalize());

	// [Execution]
    QRay<T, T> normalizedRay = RAY.Normalize();
...
QTEST_CASE_TEMPLATE ( Intersection_ReturnsFalseWhenRayDoesNotIntersectTheOrb_Test, TQTemplateTypes )
{
    ...
    float_q VECTOR_COMPONENTS_CENTER[] = { SQFloat::_1, SQFloat::_2, SQFloat::_3 };
...
QTEST_CASE_TEMPLATE ( Intersection_ReturnsTrueWhenOriginIsContainedInTheOrb_Test, TQTemplateTypes )
{
    ...
    // [Preparation]
    float_q VECTOR_COMPONENTS_ORIGIN[] = { SQFloat::_2, SQFloat::_2, SQFloat::_3 };
    float_q VECTOR_COMPONENTS_DIRECTION[] = { SQFloat::_1, SQFloat::_0, SQFloat::_0 };
    const T VALUE_FOR_ORIGIN(VECTOR_COMPONENTS_ORIGIN);
    const T VALUE_FOR_DIRECTION(VECTOR_COMPONENTS_DIRECTION);
    QRay<T, T> RAY = QRay<T, T>(VALUE_FOR_ORIGIN, VALUE_FOR_DIRECTION);
...
QTEST_CASE_TEMPLATE ( Intersection_ReturnsTrueWhenRayIsTangentToTheOrb_Test, TQTemplateTypes )
{
    ...
    // [Preparation]
    float_q VECTOR_COMPONENTS_ORIGIN[] = { SQFloat::_1, SQFloat::_3, SQFloat::_3 };
    float_q VECTOR_COMPONENTS_DIRECTION[] = { SQFloat::_1, SQFloat::_0, SQFloat::_0 };
    const T VALUE_FOR_ORIGIN(VECTOR_COMPONENTS_ORIGIN);
    const T VALUE_FOR_DIRECTION(VECTOR_COMPONENTS_DIRECTION);
    QRay<T, T> RAY = QRay<T, T>(VALUE_FOR_ORIGIN, VALUE_FOR_DIRECTION);
...
QTEST_CASE_TEMPLATE ( IntersectionPoint1_NoIntersectionPointsAreReturnedWhenRayDoesNotIntersectTheOrb_Test, TQTemplateTypes )
{
    ...
    const T VALUE_FOR_ORIGIN(VECTOR_COMPONENTS_ORIGIN);
    const T VALUE_FOR_DIRECTION(VECTOR_COMPONENTS_DIRECTION);
    const QRay<T, T> RAY = QRay<T, T>(VALUE_FOR_ORIGIN, VALUE_FOR_DIRECTION.Normalize());

    float_q VECTOR_COMPONENTS_CENTER[] = { SQFloat::_10, SQFloat::_10, SQFloat::_10 };
...
QTEST_CASE_TEMPLATE ( IntersectionPoint1_ReturnsOnePointWhenRayIsTangentToTheOrb_Test, TQTemplateTypes )
{
    ...
    // [Preparation]
    float_q VECTOR_COMPONENTS_ORIGIN[] = { SQFloat::_0, SQFloat::_3, SQFloat::_3 };
    float_q VECTOR_COMPONENTS_DIRECTION[] = { SQFloat::_1, SQFloat::_0, SQFloat::_0 };
    const T VALUE_FOR_ORIGIN(VECTOR_COMPONENTS_ORIGIN);
    const T VALUE_FOR_DIRECTION(VECTOR_COMPONENTS_DIRECTION);
    QRay<T, T> RAY = QRay<T, T>(VALUE_FOR_ORIGIN, VALUE_FOR_DIRECTION);
    ...
    const EQIntersections EXPECTED_RESULT = EQIntersections::E_One;
    float_q VECTOR_COMPONENTS_OUTPUT_POINT[] = { SQFloat::_2, SQFloat::_3, SQFloat::_3 };
    const T EXPECTED_POINT = T(VECTOR_COMPONENTS_OUTPUT_POINT);
    T OUTPUT_POINT = T::GetNullVector();
...
QTEST_CASE_TEMPLATE ( IntersectionPoint1_ReturnsNoPointsWhenRayDoesNotIntersectTheOrbButWouldDoIfInverted_Test, TQTemplateTypes )
{
    ...
    // [Preparation]
    float_q VECTOR_COMPONENTS_ORIGIN[] = { SQFloat::_0, SQFloat::_2, SQFloat::_3 };
    float_q VECTOR_COMPONENTS_DIRECTION[] = { -SQFloat::_1, SQFloat::_0, SQFloat::_0 };
    const T VALUE_FOR_ORIGIN(VECTOR_COMPONENTS_ORIGIN);
    const T VALUE_FOR_DIRECTION(VECTOR_COMPONENTS_DIRECTION);
    QRay<T, T> RAY = QRay<T, T>(VALUE_FOR_ORIGIN, VALUE_FOR_DIRECTION);
...
QTEST_CASE_TEMPLATE ( IntersectionPoint1_AssertionFailsWhenDirectionVectorIsNull_Test, TQTemplateTypes )
{
    ...
    float_q VECTOR_COMPONENTS_ORIGIN[] = { SQFloat::_1, SQFloat::_2, SQFloat::_3 };
    const T VALUE_FOR_ORIGIN(VECTOR_COMPONENTS_ORIGIN);
    const T VALUE_FOR_DIRECTION = T::GetNullVector();
    QRay<T, T> RAY = QRay<T, T>(VALUE_FOR_ORIGIN, VALUE_FOR_DIRECTION);
...
QTEST_CASE_TEMPLATE ( IntersectionPoint1_ReturnedPointIsTheClosestOneToRayOrigin_Test, TQTemplateTypes )
{
    ...
    float_q VECTOR_COMPONENTS_ORIGIN2[] = { SQFloat::_4, SQFloat::_2, SQFloat::_2 };
    float_q VECTOR_COMPONENTS_DIRECTION2[] = { -SQFloat::_1, SQFloat::_0, SQFloat::_0};
    const T VALUE_FOR_ORIGIN2(VECTOR_COMPONENTS_ORIGIN2);
    const T VALUE_FOR_DIRECTION2(VECTOR_COMPONENTS_DIRECTION2);
    const QRay<T, T> RAY2 = QRay<T, T>(VALUE_FOR_ORIGIN2, VALUE_FOR_DIRECTION2.Normalize());
    ...
    float_q VECTOR_COMPONENTS_OUTPUT_POINT[] = { SQFloat::_1, SQFloat::_2, SQFloat::_2 };
    const T EXPECTED_POINT = T(VECTOR_COMPONENTS_OUTPUT_POINT);
    float_q VECTOR_COMPONENTS_OUTPUT_POINT2[] = { SQFloat::_3, SQFloat::_2, SQFloat::_2 };
...
QTEST_CASE_TEMPLATE ( IntersectionPoint2_ReturnsTwoIntersectionPointsWhenRayIntersectsTheOrbTwice_Test, TQTemplateTypes )
{
    ...
    const EQIntersections EXPECTED_RESULT = EQIntersections::E_Two;
    float_q VECTOR_COMPONENTS_OUTPUT_POINT1[] = { SQFloat::_1, SQFloat::_2, SQFloat::_2 };
...
QTEST_CASE_TEMPLATE ( IntersectionPoint2_ReturnsOnePointWhenRayIsTangentToTheOrb_Test, TQTemplateTypes )
{
    ...
    const EQIntersections EXPECTED_RESULT = EQIntersections::E_One;
    float_q VECTOR_COMPONENTS_OUTPUT_POINT1[] = { SQFloat::_2, SQFloat::_3, SQFloat::_3 };
    const T EXPECTED_POINT1 = T(VECTOR_COMPONENTS_OUTPUT_POINT1);
    const T EXPECTED_POINT2 = T::GetNullVector();
    T OUTPUT_POINT1 = T::GetNullVector();
    T OUTPUT_POINT2 = T::GetNullVector();
