...
// ---------------------------------------------------------------------------------------------------------
// This file contains test artifacts used in QDelegate_Test.cpp to test many different cases of the QDelegate 
...
namespace Test
{
    ...
    class QMethodsDerived1 : public virtual QMethods
    {
    public:
    ...
    class QMethodsDerived2 : public virtual QMethods
    {
    public:
    ...
    class QMethodsDerived3 : public QMethodsDerived1, public QMethodsDerived2
    {
    public:
