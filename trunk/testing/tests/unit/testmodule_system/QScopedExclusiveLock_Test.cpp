...
QTEST_SUITE_BEGIN( QScopedExclusiveLock_TestSuite )
...
QTEST_CASE ( Constructor_OwnsTheMutexWhenItWasNotLockedAndInputIsTrue_Test )
{
    ...
    // [Execution]
    QScopedExclusiveLock<QMutex> lock(mutex, INPUT_VALUE);
...
QTEST_CASE ( Destructor_MutexIsUnlocked_Test )
{
    ...
    QMutex mutex;
    {
        QScopedExclusiveLock<QMutex> lock(mutex, true);
...
QTEST_CASE ( Destructor_ItDoesNothingWhenMutexIsNotLocked_Test )
{
    ...
    QMutex mutex;
    {
        QScopedExclusiveLock<QMutex> lock(mutex, false);
...
// End - Test Suite: QScopedExclusiveLock
QTEST_SUITE_END()
