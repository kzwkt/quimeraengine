...
public:
    ...
    EQFileSystemError(const EQFileSystemError::EnumType eValue) : m_value(eValue)
    {
    }
    ...
    EQFileSystemError(const enum_int_q nValue) : m_value(scast_q(nValue, const EQFileSystemError::EnumType))
    {
    }
    ...
    EQFileSystemError(const char* szValueName)
    {
        *this = szValueName;
    }
    ...
    EQFileSystemError(const EQFileSystemError &eValue) : m_value(eValue.m_value)
    {
    }
    ...
    /// </returns>
    EQFileSystemError& operator=(const enum_int_q nValue)
    {
    ...
    /// The enumerated type itself.
    /// </returns>
    EQFileSystemError& operator=(const char* szValueName)
    {
        bool bMatchFound = false;
        unsigned int uEnumStringIndex = 0;

        while(!bMatchFound && uEnumStringIndex < EQFileSystemError::_GetNumberOfValues())
        {
            bMatchFound = strcmp(sm_arStrings[uEnumStringIndex], szValueName) == 0;
            ++uEnumStringIndex;
        }

        QE_ASSERT_ERROR(uEnumStringIndex < EQFileSystemError::_GetNumberOfValues(), "The input string does not correspond to any valid enumeration value.");
    ...
    /// The enumerated type itself.
    /// </returns>
    EQFileSystemError& operator=(const EQFileSystemError::EnumType eValue)
    {
        m_value = eValue;
        return *this;
    }
    ...
    /// The enumerated type itself.
    /// </returns>
    EQFileSystemError& operator=(const EQFileSystemError &eValue)
    {
    ...
    static const Kinesis::QuimeraEngine::Common::DataTypes::QArrayBasic<const EnumType> GetValues()
    {
        ...
        static const QArrayBasic<const EnumType> ARRAY_OF_VALUES(sm_arValues, EQFileSystemError::_GetNumberOfValues());
    ...
    /// </returns>
    operator EQFileSystemError::EnumType() const
    {
        return m_value;
    }
...
private:
    ...
    /// </returns>
    inline static const char* _ConvertToString(const EQFileSystemError::EnumType eValue)
    {
        QE_ASSERT_ERROR(scast_q(eValue, unsigned int) < EQFileSystemError::_GetNumberOfValues(), "The enumeration value is not valid.");
...
private:
    ...
    /// </summary>
    static const EQFileSystemError::EnumType sm_arValues[];
