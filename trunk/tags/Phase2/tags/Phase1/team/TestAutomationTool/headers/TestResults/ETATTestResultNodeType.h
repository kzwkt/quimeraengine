...
public:
    ...
    inline ETATTestResultNodeType(const TEnumInt &nValue) : m_value(static_cast<const ETATTestResultNodeType::EnumType>(nValue))
    {
    }
...
public:
    ...
    /// </returns>
    inline ETATTestResultNodeType& operator=(const TEnumInt &nValue)
    {
