// BoostSerializationBinary.cpp : Defines the entry point for the console application.
//
...
protected:
    ...
    void serialize(Archive & ar, const unsigned int version)
    {
        ...
        ar & _stlMap;               // Works fine. Needs <boost/serialization/map.hpp> to be included.
        //ar & _arInHeap;           // Basic types pointers serialization is not allowed.
    }
...
protected:
    ...
    void serialize(Archive & ar, const unsigned int version)
    {
        ar & _strStlString;         // Works fine.
        ar & _stlVector;            // Works fine. Needs <boost/serialization/vector.hpp> to be included.
        ar & _arLetters;            // Works fine. Needs <boost/serialization/array.hpp> to be included.
        ar & _pCircularReference;   // Works fine. There is not circular serialization, it seems to follow an internal register of what woas previously serialized.
    }
};
