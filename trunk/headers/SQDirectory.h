...
#ifndef __QDIRECTORY__
#define __QDIRECTORY__
...
/// </summary>
class QE_LAYER_SYSTEM_SYMBOLS SQDirectory
{
...
public:
    ...
    /// </returns>
    static EQFileSystemError Delete(const QPath &directory);
    ...
    /// An error code depending on the result of the operation. If nothing unexpected ocurred, it returns Success.
    /// </returns>
    static EQFileSystemError Move(const QPath &directory, const QPath &newLocation, const bool bReplaceContent);
    ...
    /// An error code depending on the result of the operation. If nothing unexpected ocurred, it returns Success.
    /// </returns>
    static EQFileSystemError Rename(QPath &directory, const string_q &strNewDirectoryName);
    ...
    /// </returns>
    static EQFileSystemError Copy(const QPath &directory, const QPath& locationToCopyTo, const bool bReplaceContent);
    ...
    /// </returns>
    static QPath GetCurrentWorkingDirectory();
