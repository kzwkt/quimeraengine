...
public:
    ...
    EQComparisonType(const EQComparisonType::EnumType eValue) : m_value(eValue)
    {
    }
    ...
    EQComparisonType(const enum_int_q nValue) : m_value(scast_q(nValue, const EQComparisonType::EnumType))
    {
    }
    ...
    EQComparisonType(const char* szValueName)
    {
        *this = szValueName;
    }
    ...
    EQComparisonType(const EQComparisonType &eValue) : m_value(eValue.m_value)
    {
    }
    ...
    /// </returns>
    EQComparisonType& operator=(const enum_int_q nValue)
    {
    ...
    /// The enumerated type itself.
    /// </returns>
    EQComparisonType& operator=(const char* szValueName)
    {
        bool bMatchFound = false;
        unsigned int uEnumStringIndex = 0;

        while(!bMatchFound && uEnumStringIndex < EQComparisonType::_GetNumberOfValues())
        {
        ...
        //QE_ASSERT_ERROR(uEnumStringIndex < EQComparisonType::_GetNumberOfValues(), "The input string does not correspond to any valid enumeration value.");
    ...
    /// The enumerated type itself.
    /// </returns>
    EQComparisonType& operator=(const EQComparisonType::EnumType eValue)
    {
        m_value = eValue;
        return *this;
    }
    ...
    /// The enumerated type itself.
    /// </returns>
    EQComparisonType& operator=(const EQComparisonType &eValue)
    {
    ...
    static const Kinesis::QuimeraEngine::Common::DataTypes::QArrayBasic<const EnumType> GetValues()
    {
        ...
        static const QArrayBasic<const EnumType> ARRAY_OF_VALUES(sm_arValues, EQComparisonType::_GetNumberOfValues());
    ...
    /// </returns>
    operator EQComparisonType::EnumType() const
    {
        return m_value;
    }
...
private:
    ...
    /// </returns>
    inline static const char* _ConvertToString(const EQComparisonType::EnumType eValue)
    {
        // Commented to avoid a mutual inclusion with assertions
        //QE_ASSERT_ERROR(scast_q(eValue, unsigned int) < EQComparisonType::_GetNumberOfValues(), "The enumeration value is not valid.");
...
private:
    ...
    /// </summary>
    static const EQComparisonType::EnumType sm_arValues[];
