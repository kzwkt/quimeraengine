...
/// </summary>
class QE_LAYER_SYSTEM_SYMBOLS QAbstractCallStackTracePrinter : public virtual Kinesis::QuimeraEngine::Core::QObject
{
    QE_RTTI_SUPPORT_DERIVED_FROM_OBJECT(QAbstractCallStackTracePrinter);
...
protected:
    ...
    /// Default constructor.
    /// </summary>
    QAbstractCallStackTracePrinter();
...
public:
    ...
    /// Destructor.
    /// </summary>
    virtual ~QAbstractCallStackTracePrinter();
...
public:
    ...
    /// </summary>
    /// <param name="pFormatter">[IN] A call stack trace formatter.</param>
    virtual void SetFormatter(boost::shared_ptr<IQCallStackTraceFormatter> pFormatter);
    ...
    /// </returns>
    virtual boost::shared_ptr<IQCallStackTraceFormatter> GetFormatter() const;
