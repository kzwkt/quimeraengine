...
class QEvent< ReturnValueT(void) >
{
    // TYPEDEFS
    // ---------------
public:
...
public:
    ...
    void Raise() const
    {
        ...
        for(pointer_uint_q i = 0; i < COUNT; ++i)
            m_arSubscribers[i]();
    }
    ...
    {
        QE_ASSERT_WARNING(!m_arSubscribers.Contains(subscriber), "The input function is already subscribed to the event.");
        QE_ASSERT_ERROR(!subscriber.IsNull(), "The input function must not be null.");
    ...
    void operator-=(const Subscriber &subscriber)
    {
        ...
        pointer_uint_q uIndex = m_arSubscribers.IndexOf(subscriber);

        QE_ASSERT_WARNING(uIndex != SubscriberArray::ELEMENT_NOT_FOUND, "The input function cannot be removed, it is not subscribed to the event.");
...
class QEvent< ReturnValueT(Param1T) >
{
    // TYPEDEFS
    // ---------------
public:
...
class QEvent< ReturnValueT(Param1T, Param2T) >
{
    // TYPEDEFS
    // ---------------
public:
...
class QEvent< ReturnValueT(Param1T, Param2T, Param3T) >
{
    // TYPEDEFS
    // ---------------
public:
...
class QEvent< ReturnValueT(Param1T, Param2T, Param3T, Param4T) >
{
    // TYPEDEFS
    // ---------------
public:
...
class QEvent< ReturnValueT(Param1T, Param2T, Param3T, Param4T, Param5T) >
{
    // TYPEDEFS
    // ---------------
public:
...
class QEvent< ReturnValueT(Param1T, Param2T, Param3T, Param4T, Param5T, Param6T) >
{
    // TYPEDEFS
    // ---------------
public:
...
class QEvent< ReturnValueT(Param1T, Param2T, Param3T, Param4T, Param5T, Param6T, Param7T) >
{
    // TYPEDEFS
    // ---------------
public:
...
class QEvent< ReturnValueT(Param1T, Param2T, Param3T, Param4T, Param5T, Param6T, Param7T, Param8T) >
{
    // TYPEDEFS
    // ---------------
public:
