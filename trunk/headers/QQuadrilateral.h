...
public:
	...
	{
        SQPoint::Rotate(fRotationAngle, reinterpret_cast<QVector2*> (this), 4);
	}
	...
	{
	    quadOut = *this;
	    SQPoint::Rotate(fRotationAngle, reinterpret_cast<QVector2*> (&quadOut), 4);
	}
	...
	{
	    SQPoint::Translate(vTranslation, reinterpret_cast<QVector2*> (this), 4);
	}
	...
	{
	    SQPoint::Translate(fTranslationX, fTranslationY, reinterpret_cast<QVector2*> (this), 4);
	}
	...
	{
	    quadOut = *this;
	    SQPoint::Translate(vTranslation, reinterpret_cast<QVector2*> (&quadOut), 4);
	}
	...
	{
	    quadOut = *this;
	    SQPoint::Translate(fTranslationX, fTranslationY, reinterpret_cast<QVector2*> (&quadOut), 4);
	}
	...
	{
	    SQPoint::Scale(vScale, reinterpret_cast<QVector2*> (this), 4);
	}
	...
	{
	     SQPoint::Scale(fScaleX, fScaleY, reinterpret_cast<QVector2*> (this), 4);
	}
	...
	{
	    quadOut = *this;
	    SQPoint::Scale(vScale, reinterpret_cast<QVector2*> (&quadOut), 4);
	}
	...
	{
	    quadOut = *this;
	    SQPoint::Scale(fScaleX, fScaleY, reinterpret_cast<QVector2*> (&quadOut), 4);
	}
	...
	{
	    SQPoint::Transform(matrix, reinterpret_cast<QVector2*> (this), 4);
	}
	...
	{
	    quadOut = *this;
	    SQPoint::Transform(matrix, reinterpret_cast<QVector2*> (&quadOut), 4);
	}
	...
	{
	    SQPoint::RotateWithPivot(fRotationAngle, vPivot, reinterpret_cast<QVector2*> (this), 4);
	}
	...
	{
	    quadOut = *this;
	    SQPoint::RotateWithPivot(fRotationAngle, vPivot, reinterpret_cast<QVector2*> (&quadOut), 4);
	}
	...
	{
	    SQPoint::ScaleWithPivot(vScale, vPivot, reinterpret_cast<QVector2*> (this), 4);
	}
	...
	{
	     SQPoint::ScaleWithPivot(fScaleX, fScaleY, vPivot, reinterpret_cast<QVector2*> (this), 4);
	}
	...
	{
	    quadOut = *this;
	    SQPoint::ScaleWithPivot(vScale, vPivot, reinterpret_cast<QVector2*> (&quadOut), 4);
	}
	...
	{
	    quadOut = *this;
	    SQPoint::ScaleWithPivot(fScaleX, fScaleY, vPivot, reinterpret_cast<QVector2*> (&quadOut), 4);
	}
	...
	{
	    SQPoint::TransformWithPivot(matrix, vPivot, reinterpret_cast<QVector2*> (this), 4);
	}
	...
	{
	    quadOut = *this;
	    SQPoint::TransformWithPivot(matrix, vPivot, reinterpret_cast<QVector2*> (&quadOut), 4);
	}
