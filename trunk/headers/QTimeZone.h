...
#ifndef __QTIMEZONE__
#define __QTIMEZONE__
...
public:
    ...
    public:
        ...
        /// </returns>
        QDateTime GetEndInYear(const int nYear) const;
    ...
    public:
        ...
        /// </returns>
        const QTimeSpan& GetOffset() const;
...
public:
    ...
    void CalculateOffset(const QDateTime &dateTime, QTimeSpan &offset, bool &bIsNegative) const;
...
public:
    ...
    /// An amount of time to be subtracted or added to UTC time.
    /// </returns>
    const QTimeSpan& GetTimeZoneOffset() const;
    ...
    /// </returns>
    const QDstInformation& GetDstInfo() const;
...
private:
    ...
    /// </summary>
    QDstInformation m_dstInformation;

    /// <summary>
    /// The offset of the time zone (without DST adjustment).
    /// </summary>
    QTimeSpan m_timeZoneOffset;
