...
QTEST_CASE ( FriendOperatorProduct_EveryElementIsMultipliedByTheScalar_Test )
{
    ...
    const QMatrix4x3 MATRIX(SQFloat::_1, SQFloat::_2, SQFloat::_3,
                            ...
                            SQFloat::_10, (float_q)11.0, (float_q)12.0);
    ...
    const float_q EXPECTED_VALUE_FOR_30 = (float_q)20.0;
    const float_q EXPECTED_VALUE_FOR_31 = (float_q)22.0;
    const float_q EXPECTED_VALUE_FOR_32 = (float_q)24.0;
...
QTEST_CASE ( GetNullMatrix_AllElementsEqualZero_Test )
{
	...
	// [Execution]
    QMatrix4x3 matrixUT = QMatrix4x3::GetNullMatrix();
...
QTEST_CASE ( OperatorProduct2_CommonMatricesAreCorrectlyMultiplied_Test )
{
    ...
    const QBaseMatrix3x3 OPERAND2((float_q)13.0, (float_q)14.0, (float_q)15.0,
                                  (float_q)16.0, (float_q)17.0, (float_q)18.0,
                                  (float_q)19.0, (float_q)20.0, (float_q)21.0);

    const float_q EXPECTED_VALUE_FOR_00 = (float_q)102.0;
    const float_q EXPECTED_VALUE_FOR_01 = (float_q)108.0;
    const float_q EXPECTED_VALUE_FOR_02 = (float_q)114.0;
    const float_q EXPECTED_VALUE_FOR_10 = (float_q)246.0;
    const float_q EXPECTED_VALUE_FOR_11 = (float_q)261.0;
    const float_q EXPECTED_VALUE_FOR_12 = (float_q)276.0;
    const float_q EXPECTED_VALUE_FOR_20 = (float_q)390.0;
    const float_q EXPECTED_VALUE_FOR_21 = (float_q)414.0;
    const float_q EXPECTED_VALUE_FOR_22 = (float_q)438.0;
    const float_q EXPECTED_VALUE_FOR_30 = (float_q)534.0;
    const float_q EXPECTED_VALUE_FOR_31 = (float_q)567.0;
    const float_q EXPECTED_VALUE_FOR_32 = (float_q)600.0;
...
QTEST_CASE ( OperatorProduct3_CommonMatricesAreCorrectlyMultiplied_Test )
{
    ...
    const QBaseMatrix3x4 OPERAND2((float_q)13.0, (float_q)14.0, (float_q)15.0, (float_q)16.0,
                                  (float_q)17.0, (float_q)18.0, (float_q)19.0, (float_q)20.0,
                                  (float_q)21.0, (float_q)22.0, (float_q)23.0, (float_q)24.0);

    const float_q EXPECTED_VALUE_FOR_00 = (float_q)110.0;
    const float_q EXPECTED_VALUE_FOR_01 = (float_q)116.0;
    const float_q EXPECTED_VALUE_FOR_02 = (float_q)122.0;
    const float_q EXPECTED_VALUE_FOR_03 = (float_q)128.0;
    const float_q EXPECTED_VALUE_FOR_10 = (float_q)263.0;
    const float_q EXPECTED_VALUE_FOR_11 = (float_q)278.0;
    const float_q EXPECTED_VALUE_FOR_12 = (float_q)293.0;
    const float_q EXPECTED_VALUE_FOR_13 = (float_q)308.0;
    const float_q EXPECTED_VALUE_FOR_20 = (float_q)416.0;
    const float_q EXPECTED_VALUE_FOR_21 = (float_q)440.0;
    const float_q EXPECTED_VALUE_FOR_22 = (float_q)464.0;
    const float_q EXPECTED_VALUE_FOR_23 = (float_q)488.0;
    const float_q EXPECTED_VALUE_FOR_30 = (float_q)569.0;
    const float_q EXPECTED_VALUE_FOR_31 = (float_q)602.0;
    const float_q EXPECTED_VALUE_FOR_32 = (float_q)635.0;
    const float_q EXPECTED_VALUE_FOR_33 = (float_q)668.0;
...
QTEST_CASE ( OperatorProductAssignation1_MatrixIsCorrectlyMultipliedByScalar_Test )
{
    ...
    const QMatrix4x3 EXPECTED_VALUE(SQFloat::_2,    SQFloat::_4,    SQFloat::_6,
                                    ...
                                    (float_q)20.0, (float_q)22.0, (float_q)24.0);
...
{
    // [Preparation]
    const QMatrix4x3 MATRIX((float_q)0.9,  SQFloat::_1,    SQFloat::_2,
                            SQFloat::_7,    SQFloat::_0_5,  SQFloat::_4,
                            SQFloat::_3,    (float_q)0.07, (float_q)0.033,
                            SQFloat::_0_25, (float_q)0.08, (float_q)6.6);

    QMatrix4x3 EXPECTED_VALUE((float_q)0.9,  SQFloat::_1,    SQFloat::_2,
                              SQFloat::_7,    SQFloat::_0_5,  SQFloat::_4,
                              SQFloat::_3,    (float_q)0.07, (float_q)0.033,
                              SQFloat::_0_25, (float_q)0.08, (float_q)6.6);
...
QTEST_CASE ( OperatorDivision_EveryElementIsDividedByTheScalar_Test )
{
    ...
    const float_q EXPECTED_VALUE_FOR_22 = SQFloat::_9;
    const float_q EXPECTED_VALUE_FOR_30 = SQFloat::_10;
    const float_q EXPECTED_VALUE_FOR_31 = (float_q)11.0;
    const float_q EXPECTED_VALUE_FOR_32 = (float_q)12.0;
...
QTEST_CASE ( OperatorAddition_CommonMatricesAreCorrectlyAdded_Test )
{
    ...
    const float_q EXPECTED_VALUE_FOR_00 = (float_q)14.0;
    const float_q EXPECTED_VALUE_FOR_01 = (float_q)16.0;
    const float_q EXPECTED_VALUE_FOR_02 = (float_q)18.0;
    const float_q EXPECTED_VALUE_FOR_10 = (float_q)20.0;
    const float_q EXPECTED_VALUE_FOR_11 = (float_q)22.0;
    const float_q EXPECTED_VALUE_FOR_12 = (float_q)24.0;
    const float_q EXPECTED_VALUE_FOR_20 = (float_q)26.0;
    const float_q EXPECTED_VALUE_FOR_21 = (float_q)28.0;
    const float_q EXPECTED_VALUE_FOR_22 = (float_q)30.0;
    const float_q EXPECTED_VALUE_FOR_30 = (float_q)32.0;
    const float_q EXPECTED_VALUE_FOR_31 = (float_q)34.0;
    const float_q EXPECTED_VALUE_FOR_32 = (float_q)36.0;
...
QTEST_CASE ( OperatorSubtraction_CommonMatricesAreCorrectlySubtracted_Test )
{
    ...
    const QMatrix4x3 OPERAND1((float_q)14.0, (float_q)16.0, (float_q)18.0,
                              (float_q)20.0, (float_q)22.0, (float_q)24.0,
                              (float_q)26.0, (float_q)28.0, (float_q)30.0,
                              (float_q)32.0, (float_q)34.0, (float_q)36.0);
...
QTEST_CASE ( Transpose_TheRowAndColumOfElementsAreSwapped_Test )
{
    ...
    const QBaseMatrix3x4 EXPECTED_VALUE(SQFloat::_1,  SQFloat::_4, SQFloat::_7, SQFloat::_10,
                                        SQFloat::_2,  SQFloat::_5, SQFloat::_8, (float_q)11.0,
                                        SQFloat::_3,  SQFloat::_6, SQFloat::_9, (float_q)12.0);
...
{
    // [Preparation]
    const QMatrix4x3 NULL_MATRIX = QMatrix4x3::GetNullMatrix();
    const bool EXPECTED_VALUE = true;

    // [Execution]
    QMatrix4x3 matrixUT = NULL_MATRIX;
...
{
    // [Preparation]
    const QMatrix4x3 MATRIX(SQFloat::_0,    SQFloat::_1,    (float_q)0.654321,
                            SQFloat::_4,    SQFloat::_5,    (float_q)-2.2,
                            SQFloat::_8,    SQFloat::_9,    (float_q)123456.0,
                            (float_q)12.0, (float_q)13.0, (float_q)1234567.89);
        ...
        const string_q EXPECTED_STRING_FORM = QE_L("M4x3(0,1,0.65432100000000004,4,5,-2.2000000000000002,8,9,123456,12,13,1234567.8899999999)");
    #endif
