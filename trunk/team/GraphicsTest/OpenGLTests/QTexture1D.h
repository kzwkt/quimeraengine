...
public:
    ...
    QTexture1D(const GLuint textureId, const GLenum type, const GLenum format, const EQPixelFormat::EnumType eFormat, const u32_q uWidth, const u8_q uMipmapLevels) :
